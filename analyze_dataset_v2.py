...
try:
    # Try to load with trust_remote_code=True
    ds = load_dataset("EunsuKim/CLIcK", trust_remote_code=True)
    ...
    print(f"Error: {e}")
    print("\n=== Alternative: Try direct HuggingFace API ===")
    from huggingface_hub import HfApi
    api = HfApi()
    dataset_info = api.dataset_info("EunsuKim/CLIcK")
