"""
v3 Fine-tuned Model Evaluation on Korean History

v3 모델 평가 (Epoch 10, LR 1e-4)
"""
...
LORA_ADAPTER_PATH = "./models/qwen-click-lora-v3/final"
TEST_DATA_PATH = "./data/splits/test.json"
OUTPUT_DIR = "./benchmarks/finetuned_v3_history"
...
def main():
    print("=" * 80)
    print("[START] v3 Model Evaluation - Korean History")
    print("=" * 80)
    ...
    print(f"[INFO] Loading v3 LoRA adapter from: {LORA_ADAPTER_PATH}")
    model = PeftModel.from_pretrained(model, LORA_ADAPTER_PATH)
    model.eval()
    print("[OK] v3 LoRA adapter loaded\n")
    ...
    print("\n" + "=" * 80)
    print("[SUMMARY] v3 Evaluation Results")
    print("=" * 80)
