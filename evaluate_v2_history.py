"""
v2 Fine-tuned Model Evaluation on Korean History

조건부 프롬프트로 재학습된 모델 평가
"""
...
OUTPUT_DIR = "./benchmarks/finetuned_v2_history"
...
def main():
    print("=" * 80)
    print("[START] v2 Model Evaluation - Korean History")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("[SUMMARY] v2 Evaluation Results")
    print("=" * 80)
